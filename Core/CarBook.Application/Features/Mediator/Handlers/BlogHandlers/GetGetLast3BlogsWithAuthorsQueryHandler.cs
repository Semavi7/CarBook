...
{
    public class GetGetLast3BlogsWithAuthorsQueryHandler : IRequestHandler<GetLast3BlogsWithAuthorsQuery, List<GetLast3BlogsWithAuthorsQueryResult>>
    {
        private readonly IBlogRepository _blogRepository;

        public GetGetLast3BlogsWithAuthorsQueryHandler(IBlogRepository blogRepository)
        {
